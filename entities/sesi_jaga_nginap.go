...
type Sesi_Jaga_Nginap struct {
	...
	RuanganID          string   `gorm:"column:Ruangan_ID_Ruangan;type:varchar(5)" json:"id_jenis_ruangan" binding:"required"`
	Ruangan_ID_Ruangan *Ruangan `gorm:"foreignKey:RuanganID" json:"ruangan_id"`
	PerawatID          string   `gorm:"column:Perawat_ID_Perawat;type:varchar(4)" json:"id_perawat" binding:"required"`
	Perawat_ID_Perawat *Perawat `gorm:"foreignKey:PerawatID" json:"perawat_id"`
}
